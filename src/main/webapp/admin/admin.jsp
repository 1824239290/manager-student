<%@ page import="com.baiyun.entity.User" %><%--
    ...
    var _menus = {"menus":[
        ...
        {"menuid":"4","icon":"","menuname":"基础信息管理",
          "menus":[
            ...
            {"menuid":"43","menuname":"课程列表","icon":"icon-book-open","url":"../course/courseList.html"}
          ]
        },
...
<div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
  ...
  <span style="float:right; padding-right:20px;" class="head"><span style="color:red; font-weight:bold;">${user.nickname}&nbsp;</span>您好&nbsp;&nbsp;&nbsp;<a href="SystemServlet?method=LoginOut" id="loginOut">安全退出</a></span>
...
<div id="mainPanle" region="center" style="background: #eee; overflow-y:hidden">
  <div id="tabs" class="easyui-tabs"  fit="true" border="false" >
    <div title="欢迎使用" style="padding:20px;overflow:hidden; color:red; ">
      ...
      <p>开发人员：${systemInfo.developer}</p>
      <p>开发周期：${systemInfo.devTime}</p>

      <hr />
      <h2>系统环境</h2>
      <p>系统环境：${systemInfo.opName}</p>
      ...
      <p>系统采用技术：${systemInfo.devStack}</p>
    </div>
  </div>
</div>
